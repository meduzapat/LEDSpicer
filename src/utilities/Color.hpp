...
public:
	 ...
	 * @param color
	 * @param format true for hex (not used yet), false for dec.
	 */
	 ...
	 * @param color
	 * @param filter
	 * @param percent 0 to 100, default 50. Percent only used for Combine.
	 * @return self
	 */
	 ...
	 */
	static void loadColors(const StringUMap& colorsData, const string& format);
	...
	/**
	 * @return Returns a pointer to an array of color names.
	 */
...
protected:
	...
	/// Loaded colors.
	static unordered_map<string, const Color> colors;
